...
const static std::string controls_single[] = {
	"Move", "Left side of screen",
	"Aim", "Right side of screen",
	"Fire", "Tap middle of screen",
	"Use", "Tap with three fingers",
	"Change Weapon", "Tap with four fingers",
	"Change Camera", "Tap with five fingers",
	"Reload", "Tap with six fingers",
	//"Melee", "-",
	//"Lift/Drop", "-",
	//"Special", "-",
	//"Play/Pause Music", "-",
