...
**/
void ServerConfig::initRender(GameState *st)
{
	new RenderDebug(st);
...
**/
void ServerConfig::initAudio(GameState *st)
{
	new AudioNull(st);
}
...
**/
void ServerConfig::initPhysics(GameState *st)
{
...
**/
void ServerConfig::initMods(GameState *st)
{
	new ModManager(st);
}
